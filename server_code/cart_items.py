...
def add_to_cart(table_no,date,name,price,quantity):
    ...
    anvil.server.session['cart'].append({"table_no":table_no,"date":date,"time","name":name ,"price": price, "quantity": quantity})
